...
<div id="breadcrumb">
    <ul>
        <li>
            <a href="${pageContext.request.contextPath}/admin/dashboard">Home</a> <span> >> </span>
        </li>
        <li>
                    ...
                    <table class="display data_tbl" id="table">
                        ...
                        <c:forEach var="user" items="${users}">
                            <tr>
                                ...
                                <td>
                                    <span><a class="action-icons c-edit" href="${pageContext.request.contextPath}/admin/edit-user/${user.id}" title="Edit">Edit</a></span><span><a class="action-icons c-approve" href="${pageContext.request.contextPath}/admin/registration" title="Create">Create</a></span>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
